<%-- 
    Document   : BusquedaRecetasUsuario
    Created on : 11/01/2021, 12:52:31 AM
    Author     : Daniel
--%>
                ...
                %>
                                <li class="receta">
                                    <div class="contreceta">
                                            ...
                                            <div class="contenlacereceta"><a href="ControladorReceta?accion=listrecetaUsuario&idReceta=<%= rs.getInt("idReceta")%>" class="enlacereceta">Ir</a></div>
                                    </div>
                                </li>
                    <%}%>
