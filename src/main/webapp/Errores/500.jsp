<%-- 
    Document   : 500
    Created on : 28/12/2020, 03:15:08 AM
    Author     : Daniel
--%>
    ...
    <body>
        ...
        <section class="main">
			...
			<div class="Parrafo" style="width:300px; margin-left:auto; margin-right:auto; color:white;">
			  <p style="font-size: 20px;">Sucedió un error al intentar acceder al servidor, porfavor da click en:</p> 
			  <br>
			  <a href="javascript: history.go(-1)">Regresar</a>
			  <br>
			  <br>
			  <br>
			  <img src="https://cdn.onlinewebfonts.com/svg/img_376288.png" style="width: 100px;" alt="">
			</div>
		</section>
