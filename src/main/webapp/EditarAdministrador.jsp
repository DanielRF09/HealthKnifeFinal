<%-- 
    ...
    Created on : 25/12/2020, 11:30:59 PM
    Author     : Daniel
--%>
    ...
    <body>
        ...
        <section class="form-registro">
            ...
            <%
                ...
                int idAdministrador= Integer.parseInt((String)request.getAttribute("idAdministrador"));
                
                Administrador adm = (Administrador)dao.list(idAdministrador);
            ...
            <form action="ControladorAdministrador" method="post">
                ...
                <input type="text" class="controls" name="nombreAdmin" id="nombreAdmin" value="<%= adm.getNombreAdmin()%>" placeholder="Ingrese el nombre" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="text" class="controls" name="appatAdmin" id="appatAdmin" value="<%= adm.getAppatAdmin()%>" placeholder="Ingrese el apellido paterno" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                ...
                <a href="ControladorAdministrador?accion=listar">Regresar</a>
            </form>
