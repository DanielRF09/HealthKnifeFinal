<%-- 
    ...
    Created on : 16/12/2020, 09:40:18 PM
    Author     : Daniel
--%>
    ...
    <body>
        ...
        <section class="form-registro">
            ...
            <%
                ...
                Usuario usu = (Usuario)dao.list(idUsuario);
            ...
            <form action="Controlador" method="post">
                ...
                <input type="text" class="controls" name="nombreUsuario" id="nombreUsuario" placeholder="Ingrese el nombre" value="<%= usu.getNombreUsuario()%>" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="text" class="controls" name="appatUsuario" id="appatUsuario" placeholder="Ingrese el apellido paterno" value="<%= usu.getAppatUsuario() %>" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
