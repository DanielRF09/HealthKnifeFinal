<%-- 
    Document   : EditarNutriologo
    Created on : 16/12/2020, 08:40:38 PM
    Author     : Daniel
--%>
...
<html>
    <head>
        ...
        <title>Editar Datos del Nutriologo</title>
    ...
    <body>
        ...
        <section class="form-registro">
            ...
            <%
                ...
                int idNutriologo= Integer.parseInt((String)request.getAttribute("idNutriologo"));
                
                Nutriologo nut = (Nutriologo)dao.list(idNutriologo);
            
            %>
            
            <h4>Editar Nutriologo</h4>
            <form action="ControladorNutriologo" method="post">
                
                <input type="text" class="controls" name="nombreNutriologo" id="nombreNutriologo" value="<%= nut.getNombreNutriologo()%>" placeholder="Ingrese el nombre" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="text" class="controls" name="appatNutriologo" id="appatNutriologo" value="<%= nut.getAppatNutriologo()%>" placeholder="Ingrese el apellido paterno" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="text" class="controls" name="apmatNutriologo" id="apmatNutriologo" value="<%= nut.getApmatNutriologo()%>" placeholder="Ingrese el apellido materno" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="text" class="controls" name="sexoNutriologo" id="sexoNutriologo" value="<%= nut.getSexoNutriologo()%>" placeholder="Ingrese el sexo" required minlength="1" maxlength="1" onkeypress="return validarn(event)">
                ...
                <a href="ControladorNutriologo?accion=listar">Regresar</a>
            </form>
