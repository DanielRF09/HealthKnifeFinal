<%-- 
    Document   : BusquedaRecetasNutriologo
    Created on : 11/01/2021, 12:52:54 AM
    Author     : Daniel
--%>
                ...
                %>
                                <li class="receta">
                                    <div class="contreceta">
                                            ...
                                            <div class="contenlacereceta"><a href="ControladorReceta?accion=listrecetaNutriologo&idReceta=<%= rs.getInt("idReceta")%>" class="enlacereceta">Ir</a></div>
                                    </div>
                                </li>
                                <%}%>
