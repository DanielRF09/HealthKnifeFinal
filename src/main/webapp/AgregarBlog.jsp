<%-- 
    Document   : AgregarBlog
    Created on : 7/01/2021, 01:41:59 AM
    Author     : Daniel
--%>
...
<html>
    <head>
        ...
        <title>Formulario para Agregar Contenidos</title>
    ...
    <body>
        ...
        <section class="form-registro">  
            ...
            <form action="ControladorBlog" method="post">
                <input type="text" class="controls" name="tituloBlog" id="tituloBlog" placeholder="Ingrese el titulo del Blog" required minlength="1" maxlength="100">
                <input type="text" class="controls" name="imgBlog" id="imgBlog" placeholder="Ingrese la url de la imagen" required minlength="1" maxlength="254" >
                <textarea class="controls" name="cuerpoBlog" id="cuerpoBlog" placeholder="Ingrese el cuerpo" required rows="10"></textarea>
                
                <input type="submit" class="botones" name="accion" value="Registrar">  
                <a href="ControladorBlog?accion=listar" style="margin-left: 45%;">Regresar</a>
            </form>
