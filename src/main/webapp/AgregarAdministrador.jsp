<%-- 
    ...
    Created on : 25/12/2020, 11:30:42 PM
    Author     : Daniel
--%>
...
<html>
    <head>
        ...
        <title>Formulario para Agregar Administrador</title>
    ...
    <body oncopy="return false" onpaste="return false">
        ...
        <section class="form-registro">  
            ...
            <form action="ControladorAdministrador" method="post">
                <input type="text" class="controls" name="nombreAdmin" id="nombreAdmin" placeholder="Ingrese el nombre" required minlength="1" maxlength="44">
                <input type="text" class="controls" name="appatAdmin" id="appatAdmin" placeholder="Ingrese el apellido paterno" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="text" class="controls" name="apmatAdmin" id="apmatAdmin" placeholder="Ingrese el apellido materno" required minlength="1" maxlength="44" onkeypress="return validarn(event)">
                <input type="date" class="controls" name="fechaAdmin" id="fechaAdmin" required>
                <input type="text" class="controls" name="telefonoAdmin" id="telefonoAdmin" placeholder="Ingrese el telefono" required minlength="10" maxlength="10" onkeypress="return validarcp(event)">
                <input type="email" class="controls" name="correoAdmin" id="correoAdmin" placeholder="Ingrese su correo" required  minlength="6" maxlength="44">
                <input type="text" class="controls" name="userAdmin" id="userAdmin" placeholder="Ingrese su nombre de usuario" required minlength="6" maxlength="44">
                <input type="password" class="controls" name="passwordAdmin" id="passwordAdmin" placeholder="Ingrese su contraseña" required minlength="4" maxlength="25">
                
                <input type="submit" class="botones" name="accion" value="Registrar">  
                <a href="ControladorAdministrador?accion=listar" style="margin-left: 45%;">Regresar</a>
            </form>
