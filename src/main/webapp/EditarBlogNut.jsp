    ...
    <body oncopy="return false" onpaste="return false">
        ...
        <section class="form-registro">
            ...
            <form action="ControladorBlog" method="post">
                ...
                <input type="text" class="controls" name="tituloBlog" id="tituloBlog" placeholder="Ingrese el titulo del Blog" value="<%= blo.getTituloBlog()%>" required minlength="1" maxlength="99">
                ...
                <input type="submit" class="botones" name="accion" value="ActualizarNut">
                <a href="ControladorBlog?accion=listarNutriologos">Regresar</a>
            </form>
